...
// định nghĩa lại định dạng user trả về ở response, không nên để matkhau
...
useSchema.pre('save', async function(next) {
    const user = this
//đk trả về true khi tài khoản lập mới hoặc đổi req.body có field là "matkhau" mà k cần khác mật khẩu cũ
